                ...
                <div className="flex flex-col md:grid md:grid-cols-4 gap-12 md:gap-8 mb-24">
                    ...
                    <div className="md:col-span-1 space-y-6">
                        ...
                        <p className="text-white/40 text-sm leading-relaxed max-w-xs font-sans">
                            Capturing the energy of music and nightlife culture worldwide.
                        </p>
                    </div>
                    ...
                    <div className="md:col-start-3 md:col-span-1 space-y-6">
                        ...
                        <ul className="space-y-4 font-mono text-sm uppercase tracking-wider text-white/70">
                            ...
                            <li><a href="/info" className="hover:text-white transition-colors">Services</a></li>
                    ...
                    <div className="md:col-span-1 space-y-6">
                        ...
                        <div className="pt-4">
                            <a href="/#contact" className="inline-block border border-white/20 px-6 py-3 font-mono text-xs uppercase tracking-widest hover:bg-white hover:text-black transition-colors">
                                Start a Project
                            </a>
                        </div>
                    </div>
